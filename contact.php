            ...
            <div class="tab-pane fade" id="menu-tab-2" role="tabpanel" aria-labelledby="menu-tab-2-tab">
                <div class="side-info mb-30">
                    <div class="contact-list mb-30">
                        ...
                        <p> Revitalize Clinic, Shop No. 16, Ground Floor, Phase 2, Palacia, Kawesar Road, opposite Swastik Regalia, Waghbil, Thane, Maharashtra 400607</p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p>+91 8879588058</p>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="contact__desc">
                                                    ...
                                                    <h6>info@drmanishratnakar.com</h6>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="contact__icon">
                                            ...
                                            <li>
                                                ...
                                                <div class="contact__desc">
                                                    <span> Synopsis Clinic, Shop No 04,tilak Road, Radha-krushna, Niwas, Opp. Yashomangal Society, Panvel, Navi Mumbai, Maharashtra 410206, India</h6>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
