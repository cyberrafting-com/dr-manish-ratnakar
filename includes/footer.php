...
<footer class="footer" style="background: #575247; >
    ...
    <div class="footer__bottom pt-10 pb-10">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                ...
                <div class="footer-widget pl-30">
                    ...
                    <div class="icon-footer">
                        ...
                        <a href=""><img src="img/logo/Revitalize Clinic manish ratnakar.jpg" alt=""></a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                ...
                <div class="footer-widget pl-30">
                    ...
                    <h4 class="title text-white">Follow Us</h4>

                    <div class="social__icon text-start">

                        <a href="https://www.facebook.com/therevitalizeclinic"><i class="fab fa-facebook-f"></i></a>
